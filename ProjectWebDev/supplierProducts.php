<?php
    ...
    $_SESSION["userType"] = "supplier"; //declare user type 
    ...
    $pampanga = "pampanga";
    $pampanga_sql = "select * from sproducts_db where brand = '".$pampanga."' order by id asc";
    $pampanga_result = mysqli_query($data, $pampanga_sql);

    $cdo = "cdo";
    $cdo_sql = "select * from sproducts_db where brand = '".$cdo."' order by id asc";
    $cdo_result = mysqli_query($data, $cdo_sql);

    $tender = "tender";
    $tender_sql = "select * from sproducts_db where brand = '".$tender."' order by id asc";
    $tender_result = mysqli_query($data, $tender_sql);

    $mjb = "mjb";
    $mjb_sql = "select * from sproducts_db where brand = '".$mjb."' order by id asc";
    ...
    if(isset($_GET["action"]))          //if action=delete sa url, dito punta
    {  
...
<body>
    ...
    <div class="fullPageContainerSupplierPage">
                ...
                <div class="scrolling-wrapper">
                    ...
                    <?php  
                        ...
                        ?>  
                            ...
                            <form method="post" action="supplierProducts.php?action=add&id=<?php echo $pampanga_row["id"]; ?>">  
                                ...
                                <?php if ($pampanga_row["stock"] != 0){ ?>
                                    ...
                                    <div class="box">
                                        ...
                                        <input type="number" name = "quantity" class= "quantity_input" value="5" min="5" max="50"><br>
                ...
                <div class="scrolling-wrapper">
                    ...
                    <?php  
                        ...
                        ?>  
                            ...
                            <form method="post" action="supplierProducts.php?action=add&id=<?php echo $cdo_row["id"]; ?>">  
                ...
                <div class="scrolling-wrapper">
                    ...
                    <?php  
                        ...
                        ?>  
                            ...
                            <form method="post" action="supplierProducts.php?action=add&id=<?php echo $tender_row["id"]; ?>">  
                ...
                <div class="scrolling-wrapper">
                    ...
                    <?php  
                        ...
                        ?>  
                            ...
                            <form method="post" action="supplierProducts.php?action=add&id=<?php echo $mjb_row["id"]; ?>">  
